...
ALTER USER docmost_user WITH PASSWORD '${DOCMOST_PASSWORD}';
ALTER USER nocodb_user WITH PASSWORD '${NOCODB_PASSWORD}';
ALTER USER plane_user WITH PASSWORD '${PLANE_PASSWORD}';
